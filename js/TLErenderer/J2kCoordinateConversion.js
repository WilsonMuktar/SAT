...
var J2kCoordinateConversion = (function(){
	

	var iau80rec = 
		new Array(
			new Array(0,0,0,0,1,-171996,-174.2,92025,8.9,1), // 1
			new Array(0,0,2,-2,2,-13187,-1.6,5736,-3.1,9),
			new Array(0,0,2,0,2,-2274,-0.2,977,-0.5,31),
			new Array(0,0,0,0,2,2062,0.2,-895,0.5,2),
			new Array(0,1,0,0,0,1426,-3.4,54,-0.1,10),
			new Array(1,0,0,0,0,712,0.1,-7,0,32),
			new Array(0,1,2,-2,2,-517,1.2,224,-0.6,11),
			new Array(0,0,2,0,1,-386,-0.4,200,0,33),
			new Array(1,0,2,0,2,-301,0,129,-0.1,34),
			new Array(0,-1,2,-2,2,217,-0.5,-95,0.3,12),
			new Array(1,0,0,-2,0,-158,0,-1,0,35),
			new Array(0,0,2,-2,1,129,0.1,-70,0,13),
			new Array(-1,0,2,0,2,123,0,-53,0,36),
			new Array(1,0,0,0,1,63,0.1,-33,0,38),
			new Array(0,0,0,2,0,63,0,-2,0,37),
			new Array(-1,0,2,2,2,-59,0,26,0,40),
			new Array(-1,0,0,0,1,-58,-0.1,32,0,39),
			new Array(1,0,2,0,1,-51,0,27,0,41),
			new Array(2,0,0,-2,0,48,0,1,0,14),
			new Array(-2,0,2,0,1,46,0,-24,0,3),
			new Array(0,0,2,2,2,-38,0,16,0,42),
			new Array(2,0,2,0,2,-31,0,13,0,45),
			new Array(2,0,0,0,0,29,0,-1,0,43),
			new Array(1,0,2,-2,2,29,0,-12,0,44),
			new Array(0,0,2,0,0,26,0,-1,0,46),
			new Array(0,0,2,-2,0,-22,0,0,0,15),
			new Array(-1,0,2,0,1,21,0,-10,0,47),
			new Array(0,2,0,0,0,17,-0.1,0,0,16),
			new Array(0,2,2,-2,2,-16,0.1,7,0,18),
			new Array(-1,0,0,2,1,16,0,-8,0,48),
			new Array(0,1,0,0,1,-15,0,9,0,17),
			new Array(1,0,0,-2,1,-13,0,7,0,49),
			new Array(0,-1,0,0,1,-12,0,6,0,19),
			new Array(2,0,-2,0,0,11,0,0,0,4),
			new Array(-1,0,2,2,1,-10,0,5,0,50),
			new Array(1,0,2,2,2,-8,0,3,0,54),
			new Array(0,-1,2,0,2,-7,0,3,0,53),
			new Array(0,0,2,2,1,-7,0,3,0,58),
			new Array(1,1,0,-2,0,-7,0,0,0,51),
			new Array(0,1,2,0,2,7,0,-3,0,52),
			new Array(-2,0,0,2,1,-6,0,3,0,20),
			new Array(0,0,0,2,1,-6,0,3,0,57),
			new Array(2,0,2,-2,2,6,0,-3,0,56),
			new Array(1,0,0,2,0,6,0,0,0,55),
			new Array(1,0,2,-2,1,6,0,-3,0,58),
			new Array(0,0,0,-2,1,-5,0,3,0,60),
			new Array(0,-1,2,-2,1,-5,0,3,0,21),
			new Array(2,0,2,0,1,-5,0,3,0,62),
			new Array(1,-1,0,0,0,5,0,0,0,61),
			new Array(1,0,0,-1,0,-4,0,0,0,24),
			new Array(0,0,0,1,0,-4,0,0,0,65),
			new Array(0,1,0,-2,0,-4,0,0,0,63),
			new Array(1,0,-2,0,0,4,0,0,0,64),
			new Array(2,0,0,-2,1,4,0,-2,0,22),
			new Array(0,1,2,-2,1,4,0,-2,0,23),
			new Array(1,1,0,0,0,-3,0,0,0,66),
			new Array(1,-1,0,-1,0,-3,0,0,0,6),
			new Array(-1,-1,2,2,2,-3,0,1,0,69),
			new Array(0,-1,2,2,2,-3,0,1,0,72),
			new Array(1,-1,2,0,2,-3,0,1,0,68),
			new Array(3,0,2,0,2,-3,0,1,0,71),
			new Array(-2,0,2,0,2,-3,0,1,0,5),
			new Array(1,0,2,0,0,3,0,0,0,67),
			new Array(-1,0,2,4,2,-2,0,1,0,82),
			new Array(1,0,0,0,2,-2,0,1,0,76),
			new Array(-1,0,2,-2,1,-2,0,1,0,74),
			new Array(0,-2,2,-2,1,-2,0,1,0,7),
			new Array(-2,0,0,0,1,-2,0,1,0,70),
			new Array(2,0,0,0,1,2,0,-1,0,75),
			new Array(3,0,0,0,0,2,0,0,0,77),
			new Array(1,1,2,0,2,2,0,-1,0,73),
			new Array(0,0,2,1,2,2,0,-1,0,78),
			new Array(1,0,0,2,1,-1,0,0,0,91),
			new Array(1,0,2,2,1,-1,0,1,0,85),
			new Array(1,1,0,-2,1,-1,0,0,0,102),
			new Array(0,1,0,2,0,-1,0,0,0,99),
			new Array(0,1,2,-2,0,-1,0,0,0,30),
			new Array(0,1,-2,2,0,-1,0,0,0,27),
			new Array(1,0,-2,2,0,-1,0,0,0,103),
			new Array(1,0,-2,-2,0,-1,0,0,0,100),
			new Array(1,0,2,-2,0,-1,0,0,0,94),
			new Array(1,0,0,-4,0,-1,0,0,0,80),
			new Array(2,0,0,-4,0,-1,0,0,0,83),
			new Array(0,0,2,4,2,-1,0,0,0,105),
			new Array(0,0,2,-1,2,-1,0,0,0,98),
			new Array(-2,0,2,4,2,-1,0,1,0,86),
			new Array(2,0,2,2,2,-1,0,0,0,90),
			new Array(0,-1,2,0,1,-1,0,0,0,101),
			new Array(0,0,-2,0,1,-1,0,0,0,97),
			new Array(0,0,4,-2,2,1,0,0,0,92),
			new Array(0,1,0,0,2,1,0,0,0,28),
			new Array(1,1,2,-2,2,1,0,-1,0,84),
			new Array(3,0,2,-2,2,1,0,0,0,93),
			new Array(-2,0,2,2,2,1,0,-1,0,81),
			new Array(-1,0,0,0,2,1,0,-1,0,79),
			new Array(0,0,-2,2,1,1,0,0,0,26),
			new Array(0,1,2,0,1,1,0,0,0,95),
			new Array(-1,0,4,0,2,1,0,0,0,87),
			new Array(2,1,0,-2,0,1,0,0,0,25),
			new Array(2,0,0,2,0,1,0,0,0,104),
			new Array(2,0,2,-2,1,1,0,-1,0,89),
			new Array(2,0,-2,0,1,1,0,0,0,8),
			new Array(1,-1,0,-2,0,1,0,0,0,88),
			new Array(-1,0,0,1,1,1,0,0,0,29),
			new Array(-1,-1,0,2,1,1,0,0,0,96),
			new Array(0,1,0,1,0,1,0,0,0,106)
		);
...
//        double[] tempvec = new double[3];
        ...
        var prec = this.precess ( ttt, Opt.e80);//,  psia,wa,epsa,chia );
        var nutteme = this.truemean( ttt,order,eqeterms,optteme );
...
//            double[] aj2k = matvecmult( tempmat, ateme);
          ...
          {
            var nuttemep = this.mattrans(nutteme, 3, 3 );
		alert("nuttemep: "+nuttemep);
            var precp = this.mattrans(prec, 3, 3 );
		alert("precp: "+precp);

            tempmat = this.matmult( nuttemep, precp, 3, 3, 3 );
		alert("tempmat: "+tempmat);
...
// nut terns used, popupular choices: 4, 40, 106 (106 is max!)
	tod_j2000: function
     (
       ...
       //iau80data& iau80rec,
       ttt, ddpsi, ddeps, nutTerms // delta psi/eps correction to gcrf   rad
     )
     {
       var prec, nut, tempmat, nutp, precp;
       var psia, wa, epsa, chia;
...
//               trueeps= new Double(0), meaneps= new Double(0), omega = new Double(0);
       ...
       prec = this.precess( ttt, Opt.e80); //,  psia,wa,epsa,chia,  prec );
       
       nut = this.nutation( ttt,ddpsi,ddeps,'c',nutTerms);//,  deltapsi,deltaeps, trueeps,meaneps,omega); // iau80rec,
       ...
       if (direct == Direction.to)
         {
          ...
          {
            nutp = this.mattrans(nut, 3, 3 );
            precp = this.mattrans(prec, 3, 3 );
            tempmat = this.matmult( nutp, precp, 3, 3, 3 );
     ...
     )
     {
       ...
       prec = this.precess( ttt, Opt.e80); //,  psia,wa,epsa,chia,  prec );
        ...
        if (direct == Direction.to)
          ...
          {
            prec = this.mattrans(prec,  3, 3 ); // transpose, save back to prec (not using precp)
...
* --------------------------------------------------------------------------- */
	precess: function
     ...
     )
     {
       ...
       var psia, wa, epsa, chia;
       var convrt, zeta, theta, z, coszeta, sinzeta, costheta, sintheta,
              cosz, sinz, oblo;
       //char iauhelp;
       //sethelp(iauhelp, ' ');
       ...
       if ((opt == Opt.e80) | (opt == Opt.e96))
         ...
         {
           p1 = this.rot3mat( -chia );
           p2 = this.rot1mat( wa );
           p3 = this.rot3mat( psia );
           p4 = this.rot1mat( -oblo );

           tr1 = this.matmult( p4 , p3, 3, 3, 3 );
           tr2 = this.matmult( tr1, p2, 3, 3, 3 );
           prec = this.matmult( tr2, p1, 3, 3, 3 );
...
// returns the nut matrix
	nutation: function
     ...
     )
     {
       ...
       var deltapsi=0, deltaeps=0, trueeps=0, meaneps=0, omega=0;

       var deg2rad, cospsi, sinpsi, coseps, sineps, costrueeps, sintrueeps;
       ...
       if ( nutopt =='c' )
         {
           var tmp = this.fundarg( ttt, Opt.e80 );
           l = tmp[0];
           l1 = tmp[1];
           f = tmp[2];
           d = tmp[3];
           ...
           for (i= nutTerms; i >= 1; i --) // max 106
             {
               tempval= this.iar80(i,1) * l + this.iar80(i,2) * l1 + this.iar80(i,3) * f +
                        this.iar80(i,4) * d + this.iar80(i,5) * omega;
               deltapsi= deltapsi + (this.rar80(i,1)+this.rar80(i,2) * ttt)  *  Math.sin( tempval );
               deltaeps= deltaeps + (this.rar80(i,3)+this.rar80(i,4) * ttt) * Math.cos( tempval );
              }
...
//         }
       ...
       return new Array(l,  l1,  f,  d,  omega,
...
//          double outmat[3][3]
   ...
   {
     var outmat = [];//outmat.resize(3);  // rows
...
* --------------------------------------------------------------------------- */
	...
	truemean: function
     ...
     )
     {
       ...
       nutteme = MathUtils.mults(st, nut);
       if (opt == 'c')
         {
           nutteme[0][0] =  1.0;
           nutteme[0][1] =  0.0;
...
// row 1-106, index 1-4
rar80: function(row,index)
{
    return iau80rec[row-1][index+4] * 0.0001 /3600.0;
},

// row 1-106, index 1-5
iar80: function(row,index)
{
